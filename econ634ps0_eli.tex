...
\item Also create separate small text file if creating a large tex file
\end{enumerate}

\section{Other general notes on GitHub}

\begin{itemize}
\item Create branches and merge for different changed
\item From other branches: Do pull in to the master brach
\end{itemize}
